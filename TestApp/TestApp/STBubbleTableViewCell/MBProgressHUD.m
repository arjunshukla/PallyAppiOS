...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.labelText=@" Pally App";
		self.detailsLabelText = @"Processing...";
		self.opacity =1.0f;
		self.color = [UIColor colorWithRed:87.0f/255.0f green:187.0f/255.0f blue:157.0f/255.0f alpha:1.0f];
		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont italicSystemFontOfSize:kDetailsLabelFontSize];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        _backgroundTintColor= [UIColor redColor];
		[self registerForKVO];
	}
	return self;
}
