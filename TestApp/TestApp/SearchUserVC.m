...
@interface SearchUserVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *lbl_name=[[UILabel alloc]initWithFrame:CGRectMake(70, 10,100,20)];
    ...
    UILabel *lbl_age=[[UILabel alloc]initWithFrame:CGRectMake(70, 33,100,18)];
    ...
    UILabel *lbl_counrty=[[UILabel alloc]initWithFrame:CGRectMake(70, 54,100,18)];
